...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  for (unsigned int i = 0; i < delta_start; i++) {
    ...
    vars_upperbound[i] = 1.0e19;//Setting the actuators value to infintiy
  }
    ...
    vars_upperbound[i] = 1.0;//Acceleration values
  }
